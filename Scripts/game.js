//Graphics Assignment 2 - Sam Killen 
...
function createScene()
{
	...
	// create the paddle1's material
	   ...
	   ( { ambient: 0x050505, color: 0xD0F8A6, specular: 0x555555, shininess: 30 } );
	// create the paddle2's material
	var paddle2Material =
	   new THREE.MeshPhongMaterial
	  ( { ambient: 0x050505, color: 0x321A36, specular: 0x555555, shininess: 30 } );
	// create the plane's material	
	var planeMaterial =
	   new THREE.MeshPhongMaterial
	  ( { map: THREE.ImageUtils.loadTexture('images/texture2.jpg') } );
	// create the table's material
	var tableMaterial =
	  new THREE.MeshPhongMaterial( { map: THREE.ImageUtils.loadTexture('./images/texture2.jpg') } );
	// create the pillar's material
	var pillarmaterial =
	    new THREE.MeshPhongMaterial( { map: THREE.ImageUtils.loadTexture('./images/crowd.jpg') } );
	// create the ground's material
	var groundmaterial =
	   new THREE.MeshPhongMaterial
	   ( { map: THREE.ImageUtils.loadTexture('images/floor2.jpg') } );
	   
		
		
	  
	   var shinymaterial = new THREE.MeshPhongMaterial( { ambient: 0x050505, color: 0x0033ff, specular: 0x555555, shininess: 30 } );
	   var texturematerial = new THREE.MeshPhongMaterial( { map: THREE.ImageUtils.loadTexture('images/texture2.jpg') } );
	...
	var crowd = new THREE.Mesh(
	  ...
	  new THREE.CubeGeometry(
		planeWidth * 1,	// this creates the feel of a billiards table, with a lining
		planeHeight * 1,
		1,				// an arbitrary depth, the camera can't see much of it anyway
		planeQuality,
		planeQuality,
		1),

	  shinymaterial);
	crowd.position.z = 150;
	crowd.position.y = -150;
	...
	// create the Spheres material
	   var  sphereMaterial = 
	   new THREE.MeshPhongMaterial
	   ( { map: THREE.ImageUtils.loadTexture('images/football.jpg') } );
